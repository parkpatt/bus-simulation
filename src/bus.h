 ...
 *
 * @brief The header file for the Bus class
 */
#ifndef SRC_BUS_H_
#define SRC_BUS_H_
...
#include "./passenger.h"
#include "./passenger_loader.h"
#include "./passenger_unloader.h"
#include "./route.h"
#include "./stop.h"
...
class Bus : public IObservable {
 public:
  ...
  std::list<Passenger *> GetPassengerList() const {return passengers_;}
